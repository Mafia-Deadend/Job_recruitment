...
SECRET_KEY = 'django-insecure--y5)u-0@fy^_gd93t=4mr5n^=876#j(7ms+0#!-q2l+xrgzbh6'
...
MEDIA_URL = '/media/'  # Ensure this does not have 'media/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Ensure correct media root
